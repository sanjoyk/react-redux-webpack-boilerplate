...
import { clearAppMessage, removeAppNotification, clearAllAppMessages } from "./app-actions.js";
...
class App extends Component {
    ...
    componentDidUpdate(){
      ...
      showNotification(notifications,removeNotification){
        const notification = notifications &&  notifications.length ? notifications[notifications.length - 1]: null;
        if(notification){
      ...
      render(){
        ...
        return(
          <Router>
            <div>
              <MessageBox messages={ messages } onAcknowledgedAppMessage={onAcknowledgedAppMessage} />
